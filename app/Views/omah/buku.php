      ...
      <div class="row">
            ...
            <div class="col-sm">
              <div class="card" style="">
                <div class="card-body">
                  ...
                  <hr>
                  <a href="#" class="btn btn-success"><p class="card-text" style="font-size:14px ;">+62 274 6466541</p></a>
        ...
        <div class="col-md-8 bg-light">
          ...
          <div class="card mb-3" style="max-width: px;">
            <div class="row g-0">
                <div class="col-md-5">
                    <a href=""><img class="card-img-top w-100 p-1 text-center" src="" alt="Card image cap" style="height: 200px;"></a>
                </div>
                <div class="col-md-7">
                    <div class="card-body">
