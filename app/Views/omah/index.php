    ...
    <div class="container mt-3">
      <div class="row">
            ...
            <div class="col-md">
              <div class="card" style="">
                <div class="card-body">
                  ...
                  <hr>
                  <a href="#" class="btn btn-success"><p class="card-text" style="font-size:14px ;">02746466541</p></a>
          ...
          <?php 
            ...
            <div class="col-md-3 mt-2 pb-2" style="margin-left: -3px;">
              <div class="card" style="width: 11rem; height: 350px;">
                <a href="detail_buku.php?id_buku=<?php echo $data['id_buku']; ?>"><?php echo "<img class='card-img-top w-100 p-1 text-center' src='assets/img/$data[cover]' alt='Card image cap' style='height: 200px;'>";?></a>
                <div class="card-body text-center">
                  <p class="card-title font-weight-bold" style="display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 2; overflow: hidden;"><?php echo $data['judul']; ?></p>
                  <p style="font-size: 13px ; margin-top: -10px; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 1; overflow: hidden;"><?php echo $data['penulis']; ?></p>
                  <p style="font-size: 13px ; margin-top: -12px;"><?php echo $data['tahun_terbit']; ?></p>
                  <p style="font-size: 13px ; margin-top: -12px;"><?php echo $data['harga']; ?></p>
                  <!-- <a href="#" class="btn btn-sm-outline-primary">Detail</a> -->
                </div>
              </div>
            </div>
            <?php } ?>
        ...
        <div class="col-md-2">
          <h6>Rekomendasi</h6>
          <?php 
            $query = mysqli_query($koneksi, "SELECT * FROM buku WHERE id_buku > 10");
            while ($data = mysqli_fetch_array($query)) {
              ?>
          <div class="card mt-1 ml-1" style="width: 9rem;">
          <a href="detail_buku.php?id_buku=<?php echo $data['id_buku']; ?>"><?php echo "<img class='card-img-top w-100 p-1 text-center' src='assets/img/$data[cover]' alt='Card image cap' style='height: 200px;'>";?></a>
            <div class="card-body text-center">
              <p class="card-title font-weight-bold" style="display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 2; overflow: hidden; font-size: 13px"><?php echo $data['judul']; ?></p>
            </div>
          </div>
          <?php } ?>
        </div>
